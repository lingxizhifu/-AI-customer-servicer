    ...
    welcomeDiv.innerHTML = `
        ...
        <div class="message-content welcome-message">
            ...
            <div class="service-section">
                ...
                <div class="faq-buttons-grid">
                    <div class="faq-item-static">
                        <div class="faq-question-static">订单物流查询</div>
                    </div>
                    <div class="faq-item-static">
                        <div class="faq-question-static">退换货</div>
                    </div>
                </div>
            </div>
            ...
            <div class="service-section">
                ...
                <div class="faq-buttons-grid">
                    <div class="faq-item-static">
                        <div class="faq-question-static">店铺最近的优惠活动</div>
                    </div>
                    <div class="faq-item-static">
                        <div class="faq-question-static">我想买一些登山装备，但是不知道适合什么牌子</div>
                    </div>
                    <div class="faq-item-static">
                        <div class="faq-question-static">我想了解某个商品的详细信息</div>
                    </div>
                </div>
            </div>
