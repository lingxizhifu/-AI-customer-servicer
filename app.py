                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon blue">
                            <img src="{{ url_for('static', filename='usage-icon.png') }}" alt="使用次数" onerror="this.style.display='none'; this.parentElement.innerHTML='💡';">
                        </div>
                    </div>
                    <div class="stat-value">1,350</div>
                    <div class="stat-change">vs 昨天</div>
                </div>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon green">
                            <img src="{{ url_for('static', filename='chat-icon.png') }}" alt="对话量" onerror="this.style.display='none'; this.parentElement.innerHTML='💬';">
                        </div>
                    </div>
                    <div class="stat-value">234</div>
                    <div class="stat-change negative">13%↓</div>
                </div>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon orange">
                            <img src="{{ url_for('static', filename='solve-icon.png') }}" alt="解决率" onerror="this.style.display='none'; this.parentElement.innerHTML='✅';">
                        </div>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon red">
                            <img src="{{ url_for('static', filename='complaint-icon.png') }}" alt="投诉" onerror="this.style.display='none'; this.parentElement.innerHTML='⚠️';">
                        </div>
                    </div>
