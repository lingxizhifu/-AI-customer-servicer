...
class OfflineRAGService:
    ...
    def __init__(self, db_path="./rag_data.db"):
        ...
        for qa in qa_data:
            try:
                ...
                self.conn.execute('''
                    ...
                    VALUES (?, ?, ?, ?, ?, ?)
                ''', (qa_id, question, answer, category, question_tokens, datetime.now().isoformat()))
    ...
    def retrieve_relevant_qa(self, user_question: str, top_k: int = 5) -> List[Dict]:
        ...
        try:
            ...
            cursor = self.conn.execute('''
                SELECT question, answer, category FROM qa_data
            ''')
    ...
    def get_collection_stats(self) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'collection_name': 'offline_qa_database',
